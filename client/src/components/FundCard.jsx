        ...
        <div className='sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer' onClick={handleClick}>
            ...
            <div className="flex flex-col p-4">
                <div className='flex flex-row items-center mb-[18px]'>
                    ...
                    <p className='ml-[12px] mt-[2px] font-epilogue font-medium text-[12px] text-[#808191]'>Tech</p>
                </div>
                <div className='block'>
                ...
                <div className='flex justify-between flex-wrap mt-[15px] gap-2'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <p className='mt-[3px] font-epilogue font-normal text-[14px] leading-[18px] text-[#808191] sm:max-w-[120px] truncate'>Days left</p>
                    </div>
                </div>
                <div className='flex items-center mt-[20px] gap-[12px]'>
                    <div className='w-[30px] h-[30px] rounded-full flex justify-center items-center bg-[#13131a]'>
                        <img src={profileImg} alt="user" className='w-1/2 h-1/2 object-contain'/>
                    </div>
